<x-layouts.admin title="Pengaturan Sistem">
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <form action="{{ route('admin.settings.update') }}" method="POST" class="grid grid-cols-1 lg:grid-cols-3 gap-8" x-data="{ isLoading: false }" @submit="isLoading = true">
            @csrf
            @method('PUT')
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                    <button type="submit" :disabled="isLoading" class="w-full px-8 py-3 bg-polsri-primary hover:bg-orange-600 text-white font-bold rounded-xl shadow-lg shadow-orange-500/20 transition-all hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2">
