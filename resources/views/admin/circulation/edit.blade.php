            ...
            <div class="lg:col-span-2">
                <x-ui.card class="p-6 md:p-8">
                    ...
                    <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-slate-50">
                        ...
                        <button type="submit" class="px-6 py-2.5 rounded-xl bg-polsri-primary text-white font-bold text-sm hover:bg-orange-600 shadow-lg shadow-orange-500/20 transition hover:-translate-y-0.5">
                            Simpan Perubahan
                        </button>
                    </div>
