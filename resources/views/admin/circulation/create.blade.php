<x-layouts.admin title="Catat Peminjaman">
    ...
    <x-ui.header 
        ...
        subtitle="Gunakan kamera atau scanner untuk memproses transaksi."
        :breadcrumbs="[['label' => 'Sirkulasi', 'href' => route('admin.loans.index')], ['label' => 'Peminjaman Baru']]"
    />

    <div class="max-w-5xl mx-auto">

        <x-ui.card>
            <form action="{{ route('admin.loans.store') }}" method="POST" id="loanForm" class="p-6 md:p-8" x-data="{ isLoading: false }" @submit="isLoading = true">
                @csrf
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex gap-2 overflow-visible">
                                <div class="relative flex-1 z-50">
                                    ...
                                    <div id="student_suggestions" class="hidden absolute top-full left-0 right-0 mt-1 bg-white border border-slate-200 rounded-xl shadow-xl z-[9999] max-h-60 overflow-y-auto"></div>
                                </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex gap-2 overflow-visible">
                                <div class="relative flex-1 z-50">
                                    ...
                                    <!-- Suggestions Dropdown -->
                                    <div id="book_suggestions" class="hidden absolute top-full left-0 right-0 mt-1 bg-white border border-slate-200 rounded-xl shadow-xl z-[9999] max-h-60 overflow-y-auto"></div>
                                </div>
                ...
                <div class="mt-12 pt-6 border-t border-slate-50 flex justify-end gap-3">
                    ...
                    <button type="submit" id="btn_submit" disabled :class="{'opacity-70 cursor-not-allowed': isLoading}"
