            ...
            <div class="lg:w-2/3 xl:w-3/4 p-6 lg:p-0 mt-4 lg:mt-0">
                ...
                <div class="grid grid-cols-2 gap-4 mb-8">
                    <x-student.menu-card 
                        ...
                        label="Scan Logbook" 
                        description="Masuk perpustakaan" 
                        color="orange">
                        <x-slot name="icon">
                    ...
                    <x-student.menu-card 
                        route="{{ route('student.borrow.index') }}" 
                        label="Pinjam Buku" 
                ...
                <div class="mb-8">
                    ...
                    <div class="flex lg:grid lg:grid-cols-4 gap-4 overflow-x-auto pb-4 -mx-6 px-6 lg:mx-0 lg:px-0 lg:overflow-visible no-scrollbar snap-x snap-mandatory">
                        @forelse($recommendations as $item)
                            ...
                            @endphp
                            <x-student.recommendation-card 
                                :title="$vol['title'] ?? 'Judul'" 
                                :author="$vol['authors'][0] ?? 'Penulis'" 
                                :image="$img" 
                            />
                        @empty
                            <div class="w-full col-span-4 py-8 text-center text-slate-400 border border-dashed rounded-xl">
